    ...
    else /* else all parameter ok */
    {
        ...
        *pdw_hdl = (UINT32) (NULL );
        ...
        if (ps_object != NULL ) 
		{
            ...
            *pdw_hdl = (UINT32) (ps_object); /*lint !e923
	...
	else /* else all parameter ok */
    {
        ...
        *pdw_hdl = (UINT32) (NULL );
        ...
        if (o_firstObj) 
		{
            ...
            po_this->ps_actOdAddr = po_this->ps_startOdAddr;
            *pdw_hdl = (UINT32) (po_this->ps_actOdAddr); /*lint !e923
             Note 923: cast from pointer to
             unsigned long [MISRA 2004 Rule 11.3] */
...
BOOLEAN SOD_HdlValid(BYTE_B_INSTNUM_ UINT32 dw_hdl,
    ...
    UINT32 dw_tmpStartAddr = (UINT32) (po_this->ps_startOdAddr); /*lint !e923
     Note 923: cast from pointer to unsigned long
     [MISRA 2004 Rule 11.3] */
    /* temporary variable to increase the readability of the code */
    UINT32 dw_tmpEndAddr = (UINT32) (po_this->ps_endOdAddr); /*lint !e923
     Note 923: cast from pointer to unsigned long
     [MISRA 2004 Rule 11.3] */
