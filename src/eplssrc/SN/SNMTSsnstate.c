        ...
        UINT8 *pb_numFreeMngtFrms, BOOLEAN *po_busy) 
{
    ...
    if (checkParam(B_INSTNUM_ e_evtSn, ps_rxBuf, ps_txBuf)) 
	{
		...
		{
            o_return = InitializationState(B_INSTNUM_ dw_ct, e_evtSn);
            break;
        }
        ...
        t_SN_EVENT e_evtSn) 
{
    ...
    {
        SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF1, (UINT32)(e_evtSn));
    }
                                   ...
                                   UINT8 *pb_numFreeMngtFrms, BOOLEAN *po_busy) 
{
  ...
  {
    SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF2, (UINT32)(e_evtSn));
  }
								   ...
								   EPLS_t_FRM *ps_txBuf, BOOLEAN *po_busy) 
{
    ...
    *po_busy = FALSE;
    ...
    {
        SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF3, (UINT32)(e_evtSn));
    }
								 ...
								 EPLS_t_FRM *ps_txBuf, BOOLEAN *po_busy) 
{
  ...
  {
    SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF12, (UINT32)(e_evtSn));
  }
...
/* no SPDO active at all */
    ...
    {
        SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF4, (UINT32)(e_evtSn));
    }
									...
									EPLS_t_FRM *ps_txBuf, BOOLEAN *po_busy) 
{
    ...
    *po_busy = FALSE;
    ...
    {
        SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF5, (UINT32)(e_evtSn));
    }
								...
								EPLS_t_FRM *ps_txBuf, BOOLEAN *po_busy) 
{
  ...
  {
    SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF6, (UINT32)(e_evtSn));
  }
		                       ...
		                       BOOLEAN *po_busy) 
{
  ...
  {
    SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF7, (UINT32)(e_evtSn));
  }
		                      ...
		                      BOOLEAN *po_busy) 
{
  ...
  {
    SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF8, (UINT32)(e_evtSn));
  }
...
/* no SPDO active at all */
  ...
  {
    SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF9, (UINT32)(e_evtSn));
  }
...
/* no SPDO active at all */
	...
	{
        /* collect header info and transmit response with status PRE_OP */
        SNMTS_TxRespExtService(B_INSTNUM_ ps_rxBuf, ps_txBuf, SNMTS_k_SN_STS_OP,
                0U, 0U, (UINT8 *) NULL );
    ...
    {
        SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF10, (UINT32)(e_evtSn));
    }
...
/* no SPDO active at all */
    ...
    {
        SERR_SetError(B_INSTNUM_ SNMTS_k_ERR_EVENT_UNDEF11, (UINT32)(e_evtSn));
    }
...
static void enterAddSadr(BYTE_B_INSTNUM_ const EPLS_t_FRM *ps_rxBuf)
{
    UINT32 dw_sodHdl = 0UL; /* SOD handle to additional SADR */
    BOOLEAN o_sodAppObj = FALSE; /* SOD application flag to add. SADR */
    ...
    else /* received TxSPDO number is valid */
    {
        ...
        if(SOD_AttrGet(B_INSTNUM_ w_idxAddSadr, EPLS_k_SUBIDX_TXSPDO_SADR,
                        &dw_sodHdl, &o_sodAppObj, &s_errRes) == NULL)
        {
        ...
        else /* TxSPDO Number can be used */
        {
            ...
            if(!(SOD_Write(B_INSTNUM_ dw_sodHdl, o_sodAppObj, &w_addSadr,
