 ...
 */
BOOLEAN SERR_GetSpdoStatCtr(BYTE_B_INSTNUM_ UINT16 const w_spdoIdx,
        SERR_t_STATEVT_SPDO const e_evt, UINT32 * const pdw_statCtr);
 ...
 * - FALSE the counter is not available
 */
BOOLEAN SERR_GetAcycStatCtr(UINT16 const us_snIdx,
        SERR_t_STATEVT_ACYC const e_evt, UINT32 * const pdw_statCtr);
