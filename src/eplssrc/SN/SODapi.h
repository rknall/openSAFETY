...
const SOD_t_ATTR *SOD_AttrGet(BYTE_B_INSTNUM_ UINT16 w_idx, UINT8 b_subIdx,
        UINT32 *pdw_hdl, BOOLEAN *po_appObj,
 ...
 */
BOOLEAN SOD_Lock(BYTE_B_INSTNUM_ UINT32 dw_hdl, BOOLEAN o_appObj);
 ...
 */
BOOLEAN SOD_Unlock(BYTE_B_INSTNUM_ UINT32 dw_hdl, BOOLEAN o_appObj);
 ...
 */
#if (SOD_cfg_APPLICATION_OBJ == EPLS_k_ENABLE)
void *SAPL_SOD_ReadClbk(BYTE_B_INSTNUM_ UINT32 dw_hdl, UINT32 dw_offset,
 ...
 */
#if (SOD_cfg_APPLICATION_OBJ == EPLS_k_ENABLE)
SOD_t_ABORT_CODES SAPL_SOD_WriteClbk(BYTE_B_INSTNUM_ UINT32 dw_hdl,
        const void *pv_data,
 ...
 */
#if (SOD_cfg_APPLICATION_OBJ == EPLS_k_ENABLE)
BOOLEAN SAPL_SOD_LockClbk(BYTE_B_INSTNUM_ UINT32 dw_hdl);
#endif
 ...
 */
#if (SOD_cfg_APPLICATION_OBJ == EPLS_k_ENABLE)
BOOLEAN SAPL_SOD_UnlockClbk(BYTE_B_INSTNUM_ UINT32 dw_hdl);
#endif
 ...
 */
#if (SOD_cfg_APPLICATION_OBJ == EPLS_k_ENABLE)
SOD_t_ABORT_CODES SAPL_SOD_ActualLenSet(BYTE_B_INSTNUM_ UINT32 dw_hdl,
        UINT32 dw_actLen);
#endif
 ...
 */
#if (SOD_cfg_APPLICATION_OBJ == EPLS_k_ENABLE)
SOD_t_ABORT_CODES SAPL_SOD_ActualLenGet(BYTE_B_INSTNUM_ UINT32 dw_hdl,
        UINT32 *pdw_objLen);
#endif
 ...
 * - FALSE            - failure
 */
BOOLEAN SOD_ActualLenSet(BYTE_B_INSTNUM_ UINT32 dw_hdl, BOOLEAN o_appObj,
        UINT32 dw_actLen);
 ...
 * -FALSE            - failure
 */
BOOLEAN SOD_ActualLenGet(BYTE_B_INSTNUM_ UINT32 dw_hdl, BOOLEAN o_appObj,
        UINT32 *pdw_objLen);
