...
/* InitializationState() */
#define SNMTS_k_ERR_EVENT_UNDEF1                 SNMTS_ERR_FATAL(29)
/* WfSadrAssStep1State() */
...
#define SNMTS_k_ERR_EVENT_UNDEF2                 SNMTS_ERR_FATAL(35)
/* WfSadrAssStep2State() */
#define SNMTS_k_ERR_EVENT27                      SNMTS_ERR_MINOR(36)
#define SNMTS_k_ERR_EVENT_UNDEF3                 SNMTS_ERR_FATAL(37)
/* WfUdidScmAssState() */
...
#define SNMTS_k_ERR_EVENT_UNDEF12                SNMTS_ERR_FATAL(42)
/* WfSetToOp1Step1State() */
#define SNMTS_k_ERR_EVENT20                      SNMTS_ERR_MINOR(43)
#define SNMTS_k_ERR_EVENT_UNDEF4                 SNMTS_ERR_FATAL(44)
/* WfSetToOp1Step2State() */
#define SNMTS_k_ERR_EVENT21                      SNMTS_ERR_MINOR(45)
#define SNMTS_k_ERR_EVENT_UNDEF5                 SNMTS_ERR_FATAL(46)
/* WfApiChksumState() */
...
#define SNMTS_k_ERR_EVENT_UNDEF6                 SNMTS_ERR_FATAL(50)
/* WfSetToOp2State() */
...
#define SNMTS_k_ERR_EVENT_UNDEF7                 SNMTS_ERR_FATAL(54)
/* WfApiConfState() */
...
#define SNMTS_k_ERR_EVENT_UNDEF8                 SNMTS_ERR_FATAL(58)
/* WfSetToOp3State() */
...
#define SNMTS_k_ERR_EVENT_UNDEF9                 SNMTS_ERR_FATAL(62)
/* OperationStep1State() */
#define SNMTS_k_ERR_EVENT7                       SNMTS_ERR_MINOR(63)
#define SNMTS_k_ERR_EVENT8                       SNMTS_ERR_MINOR(64)
#define SNMTS_k_ERR_EVENT_UNDEF10                SNMTS_ERR_FATAL(65)
/* OperationStep2State() */
#define SNMTS_k_ERR_EVENT_UNDEF11                SNMTS_ERR_FATAL(66)
/* checkParam() */
